<script lang="ts">
  import { Destinations } from '$lib/components/landing';
</script>

<svelte:head>
  <title>Destinations | QCS Cargo - Caribbean Shipping Network</title>
  <meta name="description" content="Ship to Guyana, Jamaica, Trinidad & Tobago, Barbados, and Suriname. View transit times, rates, and service availability for each destination." />
</svelte:head>
  ...
  <section class="relative overflow-hidden bg-gradient-to-r from-[#023E8A] via-[#0077B6] to-[#023E8A] py-32 sm:py-40">
    ...
    <div class="container mx-auto px-4 text-center relative">
      ...
      <p class="text-base sm:text-lg text-[#CAF0F8]/75 max-w-2xl mx-auto font-light leading-relaxed tracking-wide">
        Reliable shipping to the Caribbean’s most sought‑after destinations—handled with care, clarity, and consistency.
      </p>
    </div>
  </section>
